 ...
 */
export declare function SymmetricGridMixin<ItemType = number, U extends Constructor<Array<ItemType>> | TypedArrayConstructors = Constructor<Array<ItemType>>>(Base: U): {
    new (...args: any[]): {
        [key: number]: ItemType;
        size: number;
        /**
     ...
     * @return a new grid
     */
    create<T extends any & U>(this: T, columns: number): InstanceType<T>;
    /**
